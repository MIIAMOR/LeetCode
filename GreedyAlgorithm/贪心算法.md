...
### 1.[摆动序列](https://leetcode-cn.com/problems/wiggle-subsequence)
...
### 3.[种花问题](https://leetcode-cn.com/problems/can-place-flowers/)
...
### 4.[用最少数量的箭引爆气球](https://leetcode-cn.com/problems/minimum-number-of-arrows-to-burst-balloons/)
...
### 5.[划分字母区间](https://leetcode-cn.com/problems/partition-labels/)
...
### 3.[根据身高重建队列](https://leetcode-cn.com/problems/queue-reconstruction-by-height/)
